// Fluid Particle Simulation - GPU (OpenGL / P2D renderer)
// Demonstrates GPU-accelerated rendering with thousands of particles
...
void setup() {
  size(800, 600, P2D);  // P2D uses OpenGL (GPU accelerated)
